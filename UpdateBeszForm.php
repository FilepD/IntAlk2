...
$sql_l = "SELECT * FROM beszallito WHERE ID=" . $id;
...
<script type="text/javascript">
    telefonBe = () => {
        ...
        if (!regex.test(szam)) {
            document.getElementById("updateBeszBtn").disabled = true;
        } else {
            document.getElementById("updateBeszBtn").disabled = false;
        }
...
<body>
    <div class="w-auto">
        <!-- idejöhet a form -->
        <form action="beszUpdate.php" method="post">
